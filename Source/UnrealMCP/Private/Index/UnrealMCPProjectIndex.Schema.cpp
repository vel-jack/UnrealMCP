...
bool FUnrealMCPProjectIndex::EnsureSchema(FString& OutError)
{
    static const TCHAR* SchemaStatements[] =
    {
        ...
        TEXT("CREATE TABLE IF NOT EXISTS blueprint_components ( blueprint_object_path TEXT NOT NULL, variable_name TEXT NOT NULL, component_class_path TEXT, parent_variable_name TEXT, is_default_scene_root INTEGER NOT NULL DEFAULT 0, child_count INTEGER NOT NULL DEFAULT 0, PRIMARY KEY(blueprint_object_path, variable_name) );"),
