# UnrealMCP Legacy Milestones and Acceptance Evidence

Archived September 12, 2026. This document preserves the original milestone definitions and historical verification claims, including unfinished acceptance items. It does not define current priorities. See [the active roadmap](../ROADMAP.md). Relative links below retain their historical spelling and may refer to the former repository-root location.
